...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','org.appcelerator.addressbook.ext.js')
	...
	f = os.path.join(cwd,'Classes','OrgAppceleratorAddressbookExtModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','org.appcelerator.addressbook.ext.js']
